...
export default function CandidateLayout({ children }) {
    ...
    const navItems = [
        ...
        { name: "AI Interview Chat", href: "/candidate/chat", icon: MessageSquare },
        { name: "Interview", href: "/candidate/interview", icon: CalendarDays },
        { name: "Application Status", href: "/candidate/status", icon: FileText },
